...
cn replaces clsx and tailwind-merge. One call joins conditionals and resolves Tailwind conflicts. Don't add those two packages separately.
...
- **Template-literal className ternaries three conditions deep** → cn.
