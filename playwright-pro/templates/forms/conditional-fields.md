...
test.describe("Conditional Fields", () => {
  ...
  test("shows conditional field when trigger value selected", async ({
    page,
  }) => {
    await expect(
      page.getByRole("textbox", { name: /{{conditionalFieldLabel}}/i }),
    ).toBeHidden()
    await page
  ...
  test("hides conditional field when trigger changes back", async ({
    page,
  }) => {
    await page
      .getByRole("combobox", { name: /{{triggerField}}/i })
  ...
  test("submits form when conditional field is shown and filled", async ({
    page,
  }) => {
    await page
      .getByRole("combobox", { name: /{{triggerField}}/i })
  ...
  test("validates conditional field when it is visible", async ({ page }) => {
    ...
    await page.getByRole("button", { name: /submit/i }).click()
    await expect(
      page.getByText(/{{conditionalFieldLabel}}.*required/i),
    ).toBeVisible()
  })
  ...
  test("clears conditional field value when field is hidden", async ({
    page,
  }) => {
    await page
      .getByRole("combobox", { name: /{{triggerField}}/i })
