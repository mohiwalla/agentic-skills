...
test.describe("Remember Me", () => {
  ...
  test("sets persistent cookie when remember me is checked", async ({
    page,
    context,
  }) => {
  ...
  test("sets session-scoped cookie when remember me is unchecked", async ({
    page,
    context,
  }) => {
    await page.goto("{{baseUrl}}/login")
  ...
  test("stays logged in across browser restart with remember me", async ({
    page,
    context,
  }) => {
    await page.goto("{{baseUrl}}/login")
  ...
  test("redirects to login when persistent cookie has expired", async ({
    page,
    context,
  }) => {
  ...
  test("retains remember me checkbox state after failed login", async ({
    page,
  }) => {
    await page.goto("{{baseUrl}}/login")
    await page.getByRole("checkbox", { name: /remember me/i }).check()
...
test.describe("Remember Me", () => {
  ...
  test("sets session cookie when remember me is unchecked", async ({
    page,
    context,
  }) => {
    await page.goto("{{baseUrl}}/login")
